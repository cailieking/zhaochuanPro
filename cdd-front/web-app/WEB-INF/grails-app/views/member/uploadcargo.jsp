...
<p class="title"><span>批量发布货物</span></p>
<p class="p1"><a href="http://www.chuandd.com/static/document/user_upload_form.xls" class="btn btn-blue btn-sizem3">点击下载模版</a>&nbsp;&nbsp;批量发布货物excel模版下载</p>
...
<p class="p3">2.excel文件必须填写起始港，目的港，货量，走货日期，运输种类才能上传成功。</p>
