...
class BackUpdatorV80Service extends AbstractBackDatabaseUpdator {
	...
	def updateSchema() {
		...
		CREATE TABLE IF NOT EXISTS `inquery_price` (
				  ...
				  `delete_status` varchar(2) COLLATE utf8_bin NOT NULL,
				  PRIMARY KEY (`id`),
				  KEY `FK_info_id` (`info_id`),
				  KEY `FK_order_id` (`order_id`),
				  CONSTRAINT `FK_info_id` FOREIGN KEY (`info_id`) REFERENCES `cargo_ship_information` (`id`),
