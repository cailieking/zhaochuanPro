...
<body><%--
    ...
    <div class="content">
        <%--<div class="shipping_price_info" style="height:180px">
            ...
            --%><%--<input type="hidden" name="bookingId" id = "bookingId" value="${data.data.id}" />
                --%>
                <div class="layui-layer-title" style="cursor: move;border-radius:5px" move="ok">运价编号</div>
            ...
            <div class="content">
			    ...
			    <input type="hidden" name="serviceOrigin" value="${data.data.serviceOrigin }">
			     ...
			     <input type="hidden" name="finalDestination" value="${data.data.finalDestination }">
                    ...
                    <div class="container_box">
                            <table cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td class="common">
				    ${data.data.gp20Num }
				     <input type="hidden"  id="gp20Quantity" name="gp20Num" value="${data.data.gp20Num }">
				    </td>
					...
					<input type="hidden"  id="gp40Quantity" name="gp40Num" value="${data.data.gp40Num }">
				    </td>
				    ...
				    <input type="hidden"  id="hq40Quantity" name="hq40Num" value="${data.data.hq40Num }">
                    ...
                    <div class="rate">
                        ...
                        <div class="msg">
                            <div class="OF">
                                ...
                                <span class="price"  style="color:red;" >${data.data.ofMoney}</span>
                            </div>
                             <div class="OF">
                                <span class="name" >local：</span>
                                <span class="price"  style="color:red;" >${data.data.localMoney}</span>
                            </div>
                            <%--<div class="local">
                                <span class="name">Local：</span>
	...
	<input type="hidden" id = "status"  name="status">
        ...
        <div class="SO_info">
            <div class="header">
                <span class="title" style="font-weight: bold">S/O详情</span>
        ...
        --%><div class="reason_info">
            <div class="commodity ">
                ...
                <textarea class="msg"  id="fail_reason"></textarea >
         </div>
            <div class="remark">
                <div class="title" style="border:none">备注</div>
                <textarea class="msg" id="remarks"></textarea >
        </div>
        <div class="btn_area">
            <div class="box">
                <a href="javascript:void(0)" class="booking_btn" id ="pass_btn" style="margin-top:40px;"> 审核通过</a>
                <a href="javascript:void(0)" class="so_btn"  id="refuse_btn" style="margin-top:40px;">审核不通过</a>
                <a href="javascript:void(0)" class="back"  id="back" style="margin-top:40px;">返回</a>
            </div>
        </div>
    </div>
   </div>
             ...
             var $gp40Num =$('input[name="gp40Num"]').val()?parseInt($('input[name="gp40Num"]').val()):0;
              var $hq40Num =$('input[name="hq40Num"]').val()?parseInt($('input[name="hq40Num"]').val()):0;
				  ...
				  refuseBtn.click(function(){
					  if($("#fail_reason").val()){
					  	$("#status").val("0");
					  	$("#failReason").val($("#fail_reason").val());
						$("#remark").val($("#remarks").val());
						$("#bookingForm").submit();
					  }
					  else{
				  ...
				  back.click(function(){
					  location.href ="http://"+ window.location.host+"/booking/list";
					  });
