...
<div class="manage_middle">
    <div class="manage_md_right">
        ...
        <div class="rContent">
        	<!--单次发布-->
         <form action="${request.contextPath}/tariffManager/save"  method="post" id="dataFormCreat" >
        	<div class="singleBg">
                <div>
        	...
        	<div class="batchBg">
            	<div class="bg1">
                    ...
                    <div class="bLine">
                        ...
                        <div class="bBtn btnMod2"><a  class="bBtn btnMod2"  href="/tariffManager/downloadExampleFront">点击下载模板</a></div>
                ...
                <div class="bg2">
                	...
                	<div>
                		&nbsp;&nbsp;&nbsp;<div class="rLayoutLabel">关联供应商：<span style="color:red">*</span><input type="text"  name="mobile" id="mobile"  placeholder="输入关联供应商注册手机号"  class="box1 modTextBox testShipInfo" style="background: none repeat scroll 0 0 white !important;color: #000000!important;width:196px;height:33px"/></div>
               		</div>
               		<div></div>
                    <div class="bLine">
        	...
        	<div class="batchBg2">
            	<div class="bg1">
                    ...
                    <div class="bLine">
                        ...
                        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red">最新的模版更新于2017年3月25日</span></div>
                    </div>
                    <div class="bTishi modTishiBg">
                    	<div class="modTishiTxt">下载最新的Excel导入模版文件，保存至本地文件夹。</div>
                    </div>
                ...
                <div class="bg2">
                    ...
                    <div class="bLine2">
                    	<div class="bLabel">上传：</div> 
                        <div id="shiFileBtn2" class="bBtn btnMod2">点击上传文件</div>
                        <input  type="file" class="file filetset" name="xls2"  id="xls2"  style="display:none;">
                        <div class="shipFileData2">
                        	<div class="fileName">2017年3月23日运价上传文件.xls</div>
                            <div class="fileDel">删除</div>
                        </div>
                    </div>
	  ...
	  $(".batchBottom .Button").on("click",function()
		{
		    ...
		    var url=SITE_URL+"tariffManager/importDataFront?mobile="+mobile;
	            	...
	            	function errorCreate(){
	            		...
	            		'<div class="errorBg0">'+
	            	    	'<div class="errorBg">'+
	            	            ...
	            	            '</div>'+
	            	        '</div>'+
	            	        '<div maxSum=""  class="shipError" style="position:absolute;left:right;top:10px;" ></div>'+
	            	    '</div>';
		...
		$(".batchBottom2 .Button").on("click",function()
			{
		    var url=SITE_URL+"tariffManager/importData";
	    	var file=$.trim($("[name='xls2']").val());
	    	//var main_products=$.trim($("[name='main_products']").val());
	    	if(!file)
	    	{
	    		zcAlert('请选择文件');
