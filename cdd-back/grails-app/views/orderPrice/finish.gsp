...
<%--<div class="row">
	--%><div class="col-lg-12">
		<div class="block">
			<form action="${request.contextPath }/orderPrice/finished" method="post" id="dataForm">
			...
			<table>
				...
				<g:if test="${data.data.info!=null }">
					...
					<tr class="only-tr">
						...
						<td>船公司</td>
						<td title="船公司"><input type="text" readonly="readonly" name="shipCompany" value="${data.info.shipCompany}"/></td>
					</tr>
					<tr class="only-tr">
						<td>运输类别</td>
						<td title="运输类别">
