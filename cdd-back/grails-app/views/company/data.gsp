...
<%--<div class="row">
	--%><div class="col-lg-12">
		<div class="lump">
		<div class="layui-layer-title" style="cursor: move;border-radius:5px" move="ok">公司信息</div>
			<form action="${request.contextPath}/company/save" method="post" id="dataForm">
...
--%><script> 
$(function(){
		var hon=$("#honest").val().trim()
		if(hon==="true"){
			document.getElementById("honest1").checked="checked";
			}else{
			  document.getElementById("honest2").checked="checked";
			}
		var ver=$("#verified").val().trim()
		if(ver==="true"){
			document.getElementById("verified1").checked="checked";
			}else{
			  document.getElementById("verified2").checked="checked";
			}
		var saf=$("#safety").val().trim()
		if(saf==="true"){
			 document.getElementById("safety1").checked="checked";
			}else{
			  document.getElementById("safety2").checked="checked";
			}
　 
});
 </script>
