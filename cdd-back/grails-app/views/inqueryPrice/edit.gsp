...
<%--<div class="row">
	--%><div class="col-lg-12">
		<div class="block">
			<form action="${request.contextPath }/inqueryPrice/save" method="post" id="dataForm">
			...
			<table>
				...
				<tr class="only-tr">
					<td>附加费</td>
					<td title="附加费"><input type="text" name="extra" readonly="readonly" value="${data.data.info.prices?.extra}"/></td>
				</tr>
				<tr class="only-tr">
					<td>备注</td>
					<td title="备注">
			...
			<div class="buttons">
				<a href="javascript:;" onclick="save()" class="button button-glow button-rounded button-raised button-primary" style="margin-left: 500px;">保存</a>
