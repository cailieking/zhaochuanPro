...
<asset:javascript src="c_js/supplier_guestManage.js" />
   ...
   <div class="manage_md_right">
       ...
       <div class="inpuiry_manage_guest">
       	<div class="rControlLine">
             ...
             <div class="txt1" style="margin-left:12px;" >账期：</div>
             <select class="select1" id="account_select" onchange="searchChange()" >
             </select>
             <div class="txt1" style="margin-left:12px;"  >级别：</div>
             <select class="select1" id="level_select" onchange="searchChange()">
             </select>
       	...
       	<div class="rControlLine">
             ...
             <div class="btnR btnMod1" onClick="exportSuppliers()" >导出</div>
             </form>
